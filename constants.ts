...
export const MOCK_PROMPTS: Prompt[] = [
  {
    ...
    tags: ['写作', 'ChatGPT', 'SEO'],
    author_name: 'AlexWriter',
    likes: 124,
    is_paid: false,
    created_at: '2023-10-25',
    comments: [
      { id: 'c1', author_name: 'User123', content: '非常有用的提示词，排名提升很快！', created_at: '2023-10-26' },
      { id: 'c2', author_name: 'ContentKing', content: '结构很清晰，推荐。', created_at: '2023-10-27' }
    ]
  },
  {
    id: '2',
  ...
  },
  {
    ...
    comments: [
      { id: 'c3', author_name: 'DesignerX', content: '光影效果绝了。', created_at: '2023-10-28' }
    ]
  },
  {
    id: '4',
  ...
  },
  {
    ...
    tags: ['聊天', 'Gemini', '教育'],
    author_name: 'TeacherLee',
    likes: 78,
    is_paid: false,
    created_at: '2023-11-01',
    comments: [
      { id: 'c4', author_name: 'Student007', content: '对于备考雅思非常有帮助！', created_at: '2023-11-02' }
    ]
  }
];